...
public class CityConnect {
	 ...
	 */
	private static boolean isSameRoute(String startLocation1, String endLocation1, String startLocation2,
			String endLocation2) {
	...
	private static boolean isPositiveNonZeroInt(String integerString) {
		try {
			int integerFromString = Integer.parseInt(integerString);
			// return true if i is greater than 0
			return (integerFromString > 0 ? true : false);
